import COVID from '../assests/projects_images/Covid-19-tracker.PNG'
import amazon from '../assests/projects_images/amazon clone.PNG'
import netflix from '../assests/projects_images/netflixclone.PNG'
import facebook from '../assests/projects_images/facebook clone.PNG'
import instagram from '../assests/projects_images/instagram clone.PNG'
import tiktok from '../assests/projects_images/tiktok clone.PNG'
import whatsapp from '../assests/projects_images/whatsappclone.PNG'
import youtube from '../assests/projects_images/youtube clone.PNG'
...
const data_projects = [
    {
        ...
        category: ['react'],
        description: 'React JS, API, Material UI'
    },
    {
        name: 'Amazon Clone',
        image: amazon,
